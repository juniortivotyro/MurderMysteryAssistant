...
public final class BlockUtils
{
    ...
    {
        return getState(pos).getBoundingBox(Minecraft.getMinecraft().world, pos)
                .offset(pos);
    }
    ...
    public static float getHardness(BlockPos pos)
    {
        return getState(pos).getPlayerRelativeBlockHardness(
                Minecraft.getMinecraft().player, Minecraft.getMinecraft().world, pos);
    }
    ...
    public static void placeBlockSimple(BlockPos pos) {
        ...
        for (int i = 0; i < sides.length; i++) {
            ...
            // check line of sight
            if (Minecraft.getMinecraft().world.rayTraceBlocks(eyesPos, hitVecs[i], false,
                    true, false) != null)
                continue;
...
//                    .getDeclaredField(MinecraftForge.initialize.isObfuscated()
...
//                .getBoundingBox(Minecraft.getMinecraft().world, pos).getCenter();
...
//            Vec3d relHitVec = new Vec3d(Vec3d.getX(relCenter) * dirVec.getX(),
